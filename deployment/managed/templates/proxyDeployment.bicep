...
resource proxyVMs 'Microsoft.Compute/virtualMachines@2023-03-01' = [
  for i in range(0, length(proxyNicIDs)): {
    name: '${proxyVmName}-${i}'
    location: location
    tags: tags
...
module keyVaultRoleAssignmentDeployments 'keyVaultRoleAssignmentDeployment.bicep' = [
  for i in range(0, length(proxyNicIDs)): {
